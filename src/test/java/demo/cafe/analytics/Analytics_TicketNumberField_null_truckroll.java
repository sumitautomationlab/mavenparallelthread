...
public class Analytics_TicketNumberField_null_truckroll {
	static int newrow = 0;
	static int newrow_orion = 0;
	static boolean flag_present = false;

	public static void Analytics_TicketNumber_Field_null_truck() throws Exception {
		...
		File new_name = new File(".\\Test_Result\\Analytics_TicketNumberField_null_truckroll_"
